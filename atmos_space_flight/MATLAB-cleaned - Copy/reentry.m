...
function Y = reentry(t, o)
	...
	raddot = o(4)*sfpa;
	veldot = -g*sfpa + gn*cchi*cfpa + Xfo/m	+ omega*omega*o(3)*cla*(sfpa*cla - ...
		cfpa*cchi*sla);

	gammadot = (o(4)/o(3) - g/o(4))*cfpa - gn*cchi*sfpa/o(4) + 2*omega*schi*cla + ...
	...
	% time derivatives
	Y = [longidot; latidot; raddot; veldot; gammadot; headdot];
